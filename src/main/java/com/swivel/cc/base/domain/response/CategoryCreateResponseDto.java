...
/**
 * Response dto for create category
 */
@Getter
@Setter
public class CategoryCreateResponseDto extends ResponseDto {
    ...
    public CategoryCreateResponseDto(Category category, String timeZone) {
